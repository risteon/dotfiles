...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(root_indicator os_icon context dir_writable dir)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(command_execution_time vcs background_jobs status time ssh)
